...
class PurgeCommands(commands.Cog):
    ...
    async def purge_user(self, ctx: discord.ApplicationContext, member: discord.Member):   
        guild: discord.Guild = ctx.guild
        ...
        for messagable in messageables:
            total_messages_deleted = await MemberMgr.purge_in(member, messagable)
